...
#This script builds and installs QForte within a conda environment.

#Optionally, you may supply an argument, to specify the conda environment you wish to link.
...
#CHECK FOR CONDA
conda --version > /dev/null 2>&1 || { echo "conda not found"; exit 1;}
...
#ACTIVATE CONDA ENV
conda activate $BUILD_ENV || { echo "conda env not found"; exit 1; }
