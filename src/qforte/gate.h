...
class Gate {
  public:
     ...
     * @param parameter for QISKIT the parameter of the gate (e.g., rotation angle)
     */
    ...
    // ADDED FOR QISKIT: return the gate parameter
  ...
  private:
    ...
    // for QISKIT: Store the gate parameter (e.g., rotation angle)
